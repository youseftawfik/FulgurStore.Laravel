        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <br>
                {!!Form::open(['action' => 'AuthController@register', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data'])!!}
                <fieldset>
                    <div class="form-group">
                        <label for="cname" style="font-size: 15px">Full name</label>
                        <input type="text" class="form-control form-control-lg" id="cname" placeholder="Enter your name" name="name" required="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="font-size: 15px">Email</label>
                        <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Enter your email" name="email" required="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" style="font-size: 15px">Password</label>
                        <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Enter your password" name="password" required="">
                    </div>
                    <div class="mt-3">
                        {{Form::submit('Sign Up', ['class' => 'btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn'])}}
                    </div>
                </fieldset>
            {{Form::close()}}
            </div>
